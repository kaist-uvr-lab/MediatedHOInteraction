...
bag_path = "C:/Woojin/research/realsense/record/20250810_155715.bag"
...
def main():
    ...
    img_idx = 0
    dataset = ViTDetDataset(model_cfg)
    ...
    try:
        while True:
            ...
            detections = detector(color_image, conf=0.3, verbose=False)[0]
            ...
            dataset.update_data(color_image, boxes, right, rescale_factor=args.rescale_factor)
