...
def create_fast_model(num_features=78, num_classes=16, num_joints=21, gcn_output_dim=64, num_heads=4):
    """
...
def create_model(num_features=78, num_classes=10, num_joints=21, gcn_output_dim=64, num_heads=4):
    """
