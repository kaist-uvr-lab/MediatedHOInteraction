...
#### args ####
"""
subject 별로 gesture를 랜덤하게 이어서 수집. finger 구분은 따로해서 녹화.
gesture 별로 10회 수집?
...
def main():
    ...
    try:
        ...
        for frame_idx, color in color_frames:
            out_path = os.path.join(color_image_dir, f"frame_{frame_idx:06d}.png")
        ...
        for frame_idx, depth in depth_frames:
